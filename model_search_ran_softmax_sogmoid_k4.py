...
class Network(nn.Module):
  ...
  def genotype(self):
    ...
    gene_normal = _parse(F.sigmoid(self.alphas_normal).data.cpu().numpy(),weightsn2.data.cpu().numpy())
    gene_reduce = _parse(F.sigmoid(self.alphas_reduce).data.cpu().numpy(),weightsr2.data.cpu().numpy())
